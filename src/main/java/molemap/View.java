...
class View {
    ...
    JButton molesButton = new JButton("0.0");
    JLabel molesLabel = new JLabel("Moles");
    ...
    void createUI() {
        ...
        molesLabel.setFont(new java.awt.Font("Lucida Grande", 0, 36));
        middleBox.add(molesLabel);
        ...
        molesButton.setPreferredSize(new Dimension(600, 50));
        molesButton.setFont(new java.awt.Font("Lucida Grande", 0, 15));
        topPanel.add(volumeButton);
        topPanel.add(molesButton);
        volumeButton.addActionListener((ActionEvent e) -> {
            displayVolumeInputDialog();
        });
        topBox.add(topPanel);
        topBox.add(createVolumeFormulaBox());
        middleBox.add(topPanel);
        middleBox.add(createMolesFormulaBox());
        ...
        frame.add(middleBox, BorderLayout.SOUTH);
        frame.pack();
